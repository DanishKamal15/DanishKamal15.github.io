...
function pay() {
  ...
  // let ice = sessionStorage.getItem('icecream');
  // if (ice === null) {
  //   ice = 0;
  // } else {
  //   ice = ice;
  // }
  // let bur = sessionStorage.getItem('burger');
  // if (bur === null) {
  //   bur = 0;
  // } else {
  //   bur = bur;
  // }
  // let san = sessionStorage.getItem('sandwich');
  // if (san === null) {
  //   san = 0;
  // } else {
  //   san = san;
  // }
  // let piz = sessionStorage.getItem('pizza');
  // if (piz === null) {
  //   piz = 0;
  // } else {
  //   piz = piz;
...
function pay2() {
  ...
  // }
  // ////////////////////only for pp
  // let bur = sessionStorage.getItem('b222');
  // if (bur === null) {
  //   bur = 0;
  // } else {
  //   bur = bur;
  ...
  // let burger = sessionStorage.setItem('burger', b.value * 10);
...
function pay3() {
  ...
  // }
  // ////////////////////only for pp
  // let piz = sessionStorage.getItem('p111');
  // if (piz === null) {
  //   piz = 0;
  // } else {
  //   piz = piz;
  ...
  // let pizza = sessionStorage.setItem('pizza', e.value * 15);
  ////////////////////////////////////
...
function pay4() {
  ...
  // }
  // ////////////////////only for pp
  // let san = sessionStorage.getItem('s111');
  // if (san === null) {
  //   ice = 0;
  // } else {
  //   san = san;
